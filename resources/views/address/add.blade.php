...
<div align=center class="panel-heading">新規お届け先追加ページ</div>
...
<form class="form-horizontal" method="POST" action="{{ route('address.insert') }}">
{{ csrf_field() }}
...
<div><a href="{{ route('admin.index') }}">商品一覧へ</a></div>
